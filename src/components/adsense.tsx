...
export function AdsenseSlot() {
  ...
  return (
    <section className="adsense-slot" aria-label="Advertisement">
      <p>Advertisement</p>
      <ins className="adsbygoogle" style={{ display: "block" }} data-ad-client={publisherId} data-ad-slot={slotId} data-ad-format="auto" data-full-width-responsive="true" />
    </section>
  );
}
