...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const title = ({ en: "Free Cost Calculators & Quote Tools | zaps.work", "zh-hant": "免費成本計算器與報價工具 | zaps.work", "zh-hans": "免费成本计算器与报价工具 | zaps.work", de: "Kostenrechner und Angebots-Tools | zaps.work", ja: "無料のコスト計算機と見積もりツール | zaps.work", es: "Calculadoras de costes y presupuestos | zaps.work", fr: "Calculateurs de coûts et outils de devis | zaps.work", "pt-br": "Calculadoras de custos e orçamentos | zaps.work", ko: "무료 비용 계산기 및 견적 도구 | zaps.work" } as const)[locale];
