...
function brandedCopy(item: PrivacyCopy): PrivacyCopy {
  return Object.fromEntries(Object.entries(item).map(([key, value]) => [
    key,
    value
      .replaceAll("zaps.work", siteConfig.name)
      .replaceAll("Vercel Analytics and Google Analytics", "Google Analytics")
      .replaceAll("Vercel Analytics und Google Analytics", "Google Analytics")
      .replaceAll("Vercel AnalyticsとGoogle Analytics", "Google Analytics")
      .replaceAll("Vercel Analytics y Google Analytics", "Google Analytics")
      .replaceAll("Vercel Analytics et Google Analytics", "Google Analytics")
      .replaceAll("Vercel Analytics e Google Analytics", "Google Analytics")
      .replaceAll("Vercel Analytics와 Google Analytics", "Google Analytics")
      .replaceAll("Vercel Analytics", "Google Analytics"),
  ])) as PrivacyCopy;
}
