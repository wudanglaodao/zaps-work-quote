...
const en: Dictionary = {
  ...
  home: {
    ...
    eyebrow: "Cost and quote tools for real work",
    ...
    workflowCopy: "Enter the work, check the cost and margin, then export a clean customer document.",
    toolsKicker: "Tool library",
    toolsHeading: "Start with one calculator. Expand by scenario.",
    toolsCopy: "Live tools are available now. Upcoming tools stay visible without pretending they are ready.",
  },
  tool: {
...
const zhHant: Dictionary = {
  ...
  home: {
    ...
    eyebrow: "為真實工作而做的成本與報價工具",
    heading: "算清成本，直接報價。",
    subheading: "掌握工作成本、守住毛利，並交付清楚的客戶報價。",
    primaryCta: "開啟 3D 列印計算器",
    secondaryCta: "瀏覽工具",
    workflowKicker: "一條清楚的流程",
    workflowHeading: "從工作資料到可交付報價。",
    workflowCopy: "輸入工作內容、檢查成本與毛利，再匯出乾淨的客戶文件。",
    toolsKicker: "工具庫",
    toolsHeading: "先把一個計算器做好，再擴展更多場景。",
    toolsCopy: "已上線工具可立即使用；未開放工具清楚標示，不假裝已經完成。",
  },
  tool: {
