...
const ja: Dictionary = {
  common: {
    tools: "ツール", howItWorks: "使い方", guides: "ガイド", privacy: "プライバシー", allTools: "すべてのツール", language: "言語", currency: "通貨", searchCurrency: "通貨を検索", noCurrencyResults: "該当する通貨がありません", darkMode: "ダークモードに切り替え", lightMode: "ライトモードに切り替え", live: "公開中", soon: "近日公開", footerSummary: "製造、地域サービス、個人の仕事に役立つコスト計算と見積もりツール。GitHubでオープンソースとして公開しています。", footerPrivacyPromise: "顧客の個人情報はブラウザ内に保管されます。", footer3d: "3Dプリントコスト", footerCleaning: "清掃見積もり", footerLaser: "レーザー加工", resources: "リソース", templates: "テンプレート", pricingBasics: "価格設定の基本", contact: "お問い合わせ", feedback: "フィードバック", footerLive: "3Dプリント計算機 公開中", github: "GitHub",
  },
  home: {
