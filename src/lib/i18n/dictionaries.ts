...
const en: Dictionary = {
  ...
  home: {
    ...
    toolsCopy: "Five practical calculators are live today. Browse the complete library when you need a different job-pricing workflow.",
...
const zhHant: Dictionary = {
  ...
  home: {
    ...
    toolsCopy: "目前已有五個實用工具上線；需要其他工作報價流程時，可瀏覽完整工具庫。",
    privacyKicker: "隱私設計",
...
const de: Dictionary = {
  ...
  home: {
    ...
    toolsCopy: "Fünf praktische Rechner sind jetzt verfügbar. Für weitere Preis-Workflows steht die vollständige Tool-Bibliothek bereit.",
...
const it: Dictionary = {
  common: {
    tools: "Strumenti", howItWorks: "Come funziona", guides: "Guide", privacy: "Privacy", allTools: "Tutti gli strumenti", language: "Lingua", currency: "Valuta", searchLanguage: "Cerca lingua", noLanguageResults: "Nessuna lingua trovata", searchCurrency: "Cerca valuta", noCurrencyResults: "Nessuna valuta trovata", darkMode: "Passa alla modalità scura", lightMode: "Passa alla modalità chiara", live: "Disponibile", soon: "In arrivo", footerSummary: "Calcolatori di costo e generatori di preventivi pratici e gratuiti per produzione, servizi locali e freelance. Open source su GitHub.", footerPrivacyPromise: "I dati personali dei tuoi clienti restano solo nel tuo browser.", footer3d: "Costi stampa 3D", footerCleaning: "Preventivo pulizie", footerLaser: "Taglio laser", resources: "Risorse", templates: "Modelli", pricingBasics: "Basi di prezzo", contact: "Contatti", feedback: "Feedback", footerLive: "Calcolatore stampa 3D disponibile", github: "GitHub",
  },
  home: {
    title: "Calcolatori di costo e preventivi gratuiti | zaps.work", description: "Calcola i costi reali di lavoro, proteggi il tuo margine ed esporta preventivi pronti per il cliente con gli strumenti gratuiti di zaps.work.", eyebrow: "Calcolatore costi stampa 3D disponibile", heading: "Costi chiari. Preventivo pronto.", subheading: "Conosci il costo reale del lavoro, proteggi il tuo margine e invia un preventivo chiaro.", primaryCta: "Apri calcolatore stampa 3D", secondaryCta: "Esplora gli strumenti", workflowKicker: "Un percorso chiaro", workflowHeading: "Dai dettagli del lavoro al preventivo pronto.", workflowCopy: "Ogni strumento segue lo stesso flusso trasparente, mantenendo i parametri specifici per ogni tipo di lavoro.", toolsKicker: "Libreria strumenti", toolsHeading: "Inizia con il lavoro che hai davanti.", toolsCopy: "Cinque calcolatori pratici sono già disponibili. Esplora l'intera libreria quando ti serve un flusso di preventivazione diverso.", privacyKicker: "Privacy by design", privacyHeading: "I dati dei tuoi clienti restano tuoi.", privacyCopy: "Nomi, email, numeri di telefono, indirizzi, dati aziendali, nomi dei componenti e numeri di preventivo non lasciano mai il tuo browser.", privacyLocal: "I file PDF e CSV vengono generati localmente nel tuo browser.", privacyAnonymous: "Al momento dell'esportazione vengono registrati solo dati aggregati e anonimi di materiali, tempo, costi e margini.", privacyCta: "Scopri il nostro approccio alla privacy", privacyBrowserLabel: "Il tuo browser", privacyBlockedLabel: "Campi privati bloccati", privacyMetricsLabel: "Metriche anonime",
  },
  tool: {
    title: "Calcolatore costi stampa 3D e preventivi | zaps.work", description: "Calcola filamento, tempo macchina, elettricità, manodopera, rischio di fallimento e margine per esportare preventivi di stampa 3D.", heading: "Calcolatore costi stampa 3D", intro: "Usa materiali, tempo macchina, manodopera, rischio di fallimento e margine per calcolare il prezzo di stampa FDM ed esportare PDF o CSV.", methodologyTitle: "Cosa include il calcolatore", methodologyBody: "La stima include consumo di filamento, scarti, tempo macchina, elettricità, manodopera, imballaggio, costo di fallimento previsto, tariffa minima, margine, spedizione e tasse. Tutte le ipotesi sono personalizzabili.", privacyNote: "Il nome del cliente e le informazioni di contatto (email, telefono, indirizzo) restano nel tuo browser e non vengono salvate nel nostro database.", faqTitle: "Domande frequenti sui costi di stampa 3D", faq: [
      { question: "Come viene calcolato il preventivo consigliato?", answer: "Il sistema somma i costi di produzione e manodopera, aggiunge il rischio di fallimento stimato, applica il margine desiderato e la tariffa minima, quindi calcola le imposte." },
      { question: "Il cambio di valuta converte i valori esistenti?", answer: "Sì. Gli importi monetari vengono convertiti nella valuta selezionata e formattati con i decimali standard." },
      { question: "Posso inserire più pezzi nello stesso preventivo?", answer: "Sì. Puoi aggiungere fino a dieci articoli ed esportarli in un unico preventivo per il cliente." },
    ],
  },
  calculator: {
    input: "Dati", jobDetails: "Dettagli lavoro", printItems: "Articoli di stampa", addItem: "Aggiungi articolo", itemName: "Nome articolo", material: "Materiale", quantity: "Quantità", filament: "Filamento utilizzato", printHours: "Ore di stampa", printMinutes: "Minuti di stampa", itemCosts: "Costi e manodopera articolo", spoolPrice: "Prezzo bobina", spoolWeight: "Peso bobina", preparation: "Preparazione", postProcessing: "Post-elaborazione", packaging: "Imballaggio", sharedRates: "Tariffe condivise e rischio", machineRate: "Tariffa oraria macchina", laborRate: "Tariffa oraria manodopera", failureRate: "Tasso di fallimento", wasteRate: "Scarto materiale", powerDraw: "Potenza assorbita", electricityRate: "Tariffa elettrica", pricing: "Prezzo", targetMargin: "Margine desiderato", minimumFee: "Tariffa minima", shipping: "Spedizione", tax: "Imposta", pdfDetails: "Dati preventivo", companyName: "Nome azienda", additionalQuoteDetails: "Dati preventivo aggiuntivi", companyDetails: "Dettagli azienda", customerName: "Nome cliente", customerDetails: "Dettagli cliente", quoteNumber: "Numero preventivo", validDays: "Validità", targetQuote: "Preventivo finale", totalCost: "Costo totale", profit: "Profitto", margin: "Margine", exportPdf: "Esporta PDF", exportCsv: "Esporta CSV", copySummary: "Copia riepilogo", breakdown: "Dettaglio costi", materialCost: "Materiale", machine: "Macchina", electricity: "Elettricità", labor: "Manodopera", failureRisk: "Rischio fallimento", total: "Totale", subtotal: "Subtotale", quote: "PREVENTIVO", date: "Data", preparedFor: "Destinatario", project: "Progetto", description: "Descrizione", qty: "Qtà", unitPrice: "Prezzo unitario", amount: "Importo", validFor: "Valido per {days} giorni", copied: "Riepilogo copiato", csvExported: "CSV esportato", noConversion: "I valori esistenti non sono stati convertiti.",
  },
};

const nl: Dictionary = {
  common: {
    tools: "Tools", howItWorks: "Hoe het werkt", guides: "Gidsen", privacy: "Privacy", allTools: "Alle tools", language: "Taal", currency: "Valuta", searchLanguage: "Zoek taal", noLanguageResults: "Geen taal gevonden", searchCurrency: "Zoek valuta", noCurrencyResults: "Geen valuta gevonden", darkMode: "Schakel naar donkere modus", lightMode: "Schakel naar lichte modus", live: "Beschikbaar", soon: "Binnenkort", footerSummary: "Gratis kostencalculators en offertegeneratoren voor productie, lokale diensten en freelancers. Open source op GitHub.", footerPrivacyPromise: "Klantgegevens blijven uitsluitend in je browser.", footer3d: "3D-print kosten", footerCleaning: "Schoonmaak offerte", footerLaser: "Lasersnijden", resources: "Bronnen", templates: "Sjablonen", pricingBasics: "Prijzen basis", contact: "Contact", feedback: "Feedback", footerLive: "3D-print calculator beschikbaar", github: "GitHub",
  },
  home: {
    title: "Gratis Kostencalculators & Offerte Tools | zaps.work", description: "Bereken reële kluskosten, bewaak je marge en exporteer klantklare offertes met gratis tools van zaps.work.", eyebrow: "3D-print kostencalculator beschikbaar", heading: "Kosten erin. Offerte eruit.", subheading: "Weet wat het werk kost, bewaak je winstmarge en stuur een duidelijke offerte.", primaryCta: "Open 3D-print calculator", secondaryCta: "Bekijk tools", workflowKicker: "Een duidelijk pad", workflowHeading: "Van werkdetails naar een kant-en-klare offerte.", workflowCopy: "Elke tool volgt dezelfde heldere stroom, afgestemd op de specifieke invoer voor dat type werk.", toolsKicker: "Toolbibliotheek", toolsHeading: "Begin met het werk voor je.", toolsCopy: "Vijf praktische calculators zijn direct beschikbaar. Bekijk de complete bibliotheek wanneer je een ander prijstraject nodig hebt.", privacyKicker: "Privacy by design", privacyHeading: "Jouw klantgegevens blijven van jou.", privacyCopy: "Namen, e-mails, telefoonnummers, adressen, bedrijfsgegevens, itemnamen en offertenummers verlaten nooit je browser.", privacyLocal: "PDF- en CSV-bestanden worden lokaal in je browser gegenereerd.", privacyAnonymous: "Bij het exporteren worden alleen anonieme materiaal-, tijd-, kosten- en margedata opgeslagen.", privacyCta: "Lees onze privacybenadering", privacyBrowserLabel: "Jouw browser", privacyBlockedLabel: "Privégegevens geblokkeerd", privacyMetricsLabel: "Anonieme statistieken",
  },
  tool: {
    title: "3D-print Kostencalculator & Offerte Generator | zaps.work", description: "Bereken filament, machinetijd, elektriciteit, arbeid, faalrisico en marge om 3D-print offertes te maken.", heading: "3D-print Kostencalculator", intro: "Gebruik materiaal, machinetijd, arbeid, faalrisico en winstmarge om FDM-printprijzen te berekenen en als PDF of CSV te exporteren.", methodologyTitle: "Wat de calculator bevat", methodologyBody: "De schatting omvat filamentverbruik, afval, machinetijd, elektriciteit, arbeid, verpakking, verwacht faalrisico, minimumtarief, winstmarge, verzendkosten en belasting. Alle aannames zijn aanpasbaar.", privacyNote: "Klantnamen en contactgegevens (inclusief e-mail, telefoon en adres) blijven in je browser en worden niet opgeslagen in onze database.", faqTitle: "Veelgestelde vragen over 3D-print kosten", faq: [
      { question: "Hoe wordt de aanbevolen offerte berekend?", answer: "Het systeem telt productie- en arbeidskosten bij elkaar op, voegt verwacht faalrisico toe, past de gewenste marge en minimumtarieven toe en berekent vervolgens de belasting." },
      { question: "Worden bestaande bedragen omgerekend bij valutaverandering?", answer: "Ja. Invoerbedragen worden omgerekend naar de geselecteerde valuta en getoond volgens de standaard decimalen." },
      { question: "Kan ik meerdere printonderdelen in één offerte opnemen?", answer: "Ja. Voeg tot tien items toe en exporteer alles als één offerte voor de klant." },
    ],
  },
  calculator: {
    input: "Invoer", jobDetails: "Werkdetails", printItems: "Printitems", addItem: "Item toevoegen", itemName: "Itemnaam", material: "Materiaal", quantity: "Aantal", filament: "Gebruikt filament", printHours: "Printuren", printMinutes: "Printminuten", itemCosts: "Itemkosten en arbeid", spoolPrice: "Spoelprijs", spoolWeight: "Spoelgewicht", preparation: "Voorbereiding", postProcessing: "Nabewerking", packaging: "Verpakking", sharedRates: "Gedeelde tarieven en risico", machineRate: "Machinetarief", laborRate: "Uurtarief arbeid", failureRate: "Faalpercentage", wasteRate: "Materiaalafval", powerDraw: "Stroomverbruik", electricityRate: "Elektriciteitstarief", pricing: "Prijzen", targetMargin: "Doelmarge", minimumFee: "Minimumtarief", shipping: "Verzendkosten", tax: "Btw", pdfDetails: "Offertegegevens", companyName: "Bedrijfsnaam", additionalQuoteDetails: "Extra offertegegevens", companyDetails: "Bedrijfsdetails", customerName: "Klantnaam", customerDetails: "Klantgegevens", quoteNumber: "Offertenummer", validDays: "Geldigheidsduur", targetQuote: "Doelofferte", totalCost: "Totale kosten", profit: "Winst", margin: "Marge", exportPdf: "Exporteer PDF", exportCsv: "Exporteer CSV", copySummary: "Kopieer overzicht", breakdown: "Kostenopbouw", materialCost: "Materiaal", machine: "Machine", electricity: "Elektriciteit", labor: "Arbeid", failureRisk: "Faalrisico", total: "Totaal", subtotal: "Subtotaal", quote: "OFFERTE", date: "Datum", preparedFor: "Opgesteld voor", project: "Project", description: "Omschrijving", qty: "Aantal", unitPrice: "Eenheidsprijs", amount: "Bedrag", validFor: "Geldig voor {days} dagen", copied: "Overzicht gekopieerd", csvExported: "CSV geëxporteerd", noConversion: "Bestaande waarden zijn niet geconverteerd.",
  },
};

const pl: Dictionary = {
  common: {
    tools: "Narzędzia", howItWorks: "Jak to działa", guides: "Poradniki", privacy: "Prywatność", allTools: "Wszystkie narzędzia", language: "Język", currency: "Waluta", searchLanguage: "Szukaj języka", noLanguageResults: "Nie znaleziono języka", searchCurrency: "Szukaj waluty", noCurrencyResults: "Nie znaleziono waluty", darkMode: "Przełącz na tryb ciemny", lightMode: "Przełącz na tryb jasny", live: "Dostępne", soon: "Wkrótce", footerSummary: "Darmowe kalkulatory kosztów i generatory wycen dla produkcji, usług lokalnych i freelancerów. Open source na GitHubie.", footerPrivacyPromise: "Dane Twoich klientów pozostają wyłącznie w Twojej przeglądarce.", footer3d: "Koszt druku 3D", footerCleaning: "Wycena sprzątania", footerLaser: "Cięcie laserowe", resources: "Zasoby", templates: "Szablony", pricingBasics: "Podstawy wyceny", contact: "Kontakt", feedback: "Opinie", footerLive: "Kalkulator druku 3D dostępny", github: "GitHub",
  },
  home: {
    title: "Darmowe Kalkulatory Kosztów i Wycen | zaps.work", description: "Oblicz rzeczywiste koszty prac, chroń swoją marżę i eksportuj gotowe wyceny dla klientów z zaps.work.", eyebrow: "Kalkulator druku 3D dostępny", heading: "Wprowadź koszty. Wygeneruj wycenę.", subheading: "Poznaj rzeczywisty koszt pracy, chroń marżę i wyślij przejrzystą wycenę.", primaryCta: "Otwórz kalkulator druku 3D", secondaryCta: "Przeglądaj narzędzia", workflowKicker: "Jedna prosta ścieżka", workflowHeading: "Od szczegółów zlecenia do gotowej wyceny.", workflowCopy: "Każde narzędzie działa według tego samego schematu, zachowując specyfikę danego typu prac.", toolsKicker: "Baza narzędzi", toolsHeading: "Zacznij od pracy, którą masz przed sobą.", toolsCopy: "Pięć praktycznych kalkulatorów jest dostępnych już teraz. Przejrzyj pełną bibliotekę narzędzi, gdy potrzebujesz innej wyceny.", privacyKicker: "Prywatność z założenia", privacyHeading: "Dane Twoich klientów należą do Ciebie.", privacyCopy: "Nazwiska, adresy e-mail, numery telefonów, adresy, dane firm i numery wycen nigdy nie opuszczają Twojej przeglądarki.", privacyLocal: "Pliki PDF i CSV są generowane lokalnie w przeglądarce.", privacyAnonymous: "Podczas eksportu zapisywane są tylko anonimowe dane o materiałach, czasie, kosztach i marży.", privacyCta: "Poznaj nasze zasady prywatności", privacyBrowserLabel: "Twoja przeglądarka", privacyBlockedLabel: "Dane prywatne zablokowane", privacyMetricsLabel: "Anonimowe wskaźniki",
  },
  tool: {
    title: "Kalkulator Kosztów Druku 3D i Wycen | zaps.work", description: "Oblicz filament, czas maszyny, prąd, robociznę, ryzyko błędu i marżę, aby stworzyć wycenę druku 3D.", heading: "Kalkulator Kosztów Druku 3D", intro: "Użyj zużycia materiału, czasu pracy maszyny, robocizny, ryzyka błędu i marży, aby wycenić druk FDM i wyeksportować PDF lub CSV.", methodologyTitle: "Co zawiera kalkulator", methodologyBody: "Wycena obejmuje zużycie filamentu, odpady, czas maszyny, prąd, robociznę, pakowanie, przewidywane ryzyko błędu, stawkę minimalną, marżę, wysyłkę i podatki. Wszystkie założenia można modyfikować.", privacyNote: "Nazwiska i dane kontaktowe klientów (w tym e-mail, telefon i adres) pozostają w Twojej przeglądarce i nie są zapisywane w naszej bazie danych.", faqTitle: "Najczęstsze pytania o koszty druku 3D", faq: [
      { question: "Jak obliczana jest sugerowana wycena?", answer: "System sumuje koszty produkcji i robocizny, dodaje przewidywane ryzyko błędu, stosuje docelową marżę i opłatę minimalną, a następnie dolicza podatek." },
      { question: "Czy zmiana waluty przelicza istniejące wartości?", answer: "Tak. Kwoty są przeliczane na wybraną walutę i wyświetlane z odpowiednią liczbą miejsc po przecinku." },
      { question: "Czy mogę dodać kilka wydruków do jednej wyceny?", answer: "Tak. Możesz dodać do dziesięciu pozycji i wyeksportować je jako jedną kompletną wycenę dla klienta." },
    ],
  },
  calculator: {
    input: "Dane", jobDetails: "Szczegóły pracy", printItems: "Pozycje wydruku", addItem: "Dodaj pozycję", itemName: "Nazwa pozycji", material: "Materiał", quantity: "Ilość", filament: "Zużyty filament", printHours: "Godziny druku", printMinutes: "Minuty druku", itemCosts: "Koszty pozycji i robocizna", spoolPrice: "Cena szpuli", spoolWeight: "Waga szpuli", preparation: "Przygotowanie", postProcessing: "Obróbka końcowa", packaging: "Opakowanie", sharedRates: "Wspólne stawki i ryzyko", machineRate: "Stawka za maszynę", laborRate: "Stawka robocizny", failureRate: "Wskaźnik błędów", wasteRate: "Odpady materiału", powerDraw: "Pobór mocy", electricityRate: "Stawka za prąd", pricing: "Wycena", targetMargin: "Docelowa marża", minimumFee: "Opłata minimalna", shipping: "Wysyłka", tax: "Podatek", pdfDetails: "Dane wyceny", companyName: "Nazwa firmy", additionalQuoteDetails: "Dodatkowe dane wyceny", companyDetails: "Dane firmy", customerName: "Nazwisko klienta", customerDetails: "Dane klienta", quoteNumber: "Numer wyceny", validDays: "Ważność", targetQuote: "Docelowa wycena", totalCost: "Koszt całkowity", profit: "Zysk", margin: "Marża", exportPdf: "Eksportuj PDF", exportCsv: "Eksportuj CSV", copySummary: "Kopiuj podsumowanie", breakdown: "Podział kosztów", materialCost: "Materiał", machine: "Maszyna", electricity: "Prąd", labor: "Robocizna", failureRisk: "Ryzyko błędu", total: "Razem", subtotal: "Suma częściowa", quote: "WYCENA", date: "Data", preparedFor: "Przygotowano dla", project: "Projekt", description: "Opis", qty: "Ilość", unitPrice: "Cena jedn.", amount: "Wartość", validFor: "Ważne przez {days} dni", copied: "Skopiowano podsumowanie", csvExported: "Wyeksportowano CSV", noConversion: "Istniejące wartości nie zostały przeliczone.",
  },
};
...
const dictionaries: Record<Locale, Dictionary> = { en, "zh-hant": zhHant, "zh-hans": zhHans, de, ja, es, fr, "pt-br": ptBr, ko, it, nl, pl };
