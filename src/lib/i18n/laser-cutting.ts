...
const baseCopies: Record<Exclude<Locale, "zh-hans">, LaserCuttingCopy> = {
  ...
  it: { ...enCopy, title: "Calcolatore costi e preventivo taglio laser | zaps.work", description: "Calcola materiale, tempo macchina, attrezzaggio, movimentazione, scarti e margine.", heading: "Preventivo taglio laser", intro: "Trasforma le statistiche CAD/CAM manuali in un preventivo coerente e trasparente.", material: "Materiale", mildSteel: "Acciaio al carbonio", stainlessSteel: "Acciaio inox", aluminum: "Alluminio", acrylic: "Acrilico", plywood: "Compensato", other: "Altro materiale", materialThickness: "Spessore", thicknessUnit: "Unità spessore", materialArea: "Superficie materiale", materialRate: "Prezzo materiale", wasteRate: "Sfrido", quantity: "Quantità", measurementUnit: "Sistema di unità", squareFeet: "sq ft", squareMeters: "m²", cutStats: "Dati di taglio e macchina", cutLength: "Lunghezza di taglio", cutLengthUnit: "Unità di lunghezza", cutTimeMinutes: "Tempo di taglio", pierceCount: "Numero di sfondamenti", machineRate: "Tariffa oraria macchina", setupHandling: "Attrezzaggio e movimentazione", setupMinutes: "Tempo di attrezzaggio", handlingMinutes: "Tempo di movimentazione", laborRate: "Tariffa oraria manodopera", optionalCosts: "Finitura e altri costi", finishingCost: "Finitura per pezzo", otherCost: "Altri costi del lavoro", pricing: "Prezzi", targetMargin: "Margine obiettivo", packageDiscount: "Sconto pacchetto", taxRate: "Imposta", quoteDetails: "Dati preventivo", materialLine: "Servizio di taglio laser", targetQuote: "Preventivo finale", directCost: "Costo diretto", profit: "Profitto", margin: "Margine", materialCost: "Materiale", machineCost: "Macchina", setupCost: "Manodopera attrezzaggio", handlingCost: "Manodopera movimentazione", finishing: "Finitura", pricingFloor: "Prezzo minimo" },
  nl: { ...enCopy, title: "Lasersnijden kosten calculator en offerte | zaps.work", description: "Bereken materiaal, machinetijd, insteltijd, handling, afval en marge voor lasersnijopdrachten.", heading: "Lasersnijden offerte", intro: "Zet handmatige CAD/CAM-statistieken om in een consistente en transparante offerte.", material: "Materiaal", mildSteel: "Constructiestaal", stainlessSteel: "RVS", aluminum: "Aluminium", acrylic: "Acrylaat", plywood: "Multiplex", other: "Ander materiaal", materialThickness: "Dikte", thicknessUnit: "Diktemaat", materialArea: "Materiaaloppervlakte", materialRate: "Materiaaltarief", wasteRate: "Afvalpercentage", quantity: "Aantal", measurementUnit: "Eenhedenstelsel", squareFeet: "sq ft", squareMeters: "m²", cutStats: "Snij- en machinedata", cutLength: "Snijlengte", cutLengthUnit: "Lengtemaat", cutTimeMinutes: "Snijtijd", pierceCount: "Aantal insteken", machineRate: "Machinetarief", setupHandling: "Instellen en handling", setupMinutes: "Insteltijd", handlingMinutes: "Handlingtijd", laborRate: "Uurtarief arbeid", optionalCosts: "Nabewerking en overige kosten", finishingCost: "Nabewerking per stuk", otherCost: "Overige opdrachtkosten", pricing: "Prijzen", targetMargin: "Doelmarge", packageDiscount: "Pakketkorting", taxRate: "Btw", quoteDetails: "Offertegegevens", materialLine: "Lasersnijdienst", targetQuote: "Doelofferte", directCost: "Directe kosten", profit: "Winst", margin: "Marge", materialCost: "Materiaal", machineCost: "Machine", setupCost: "Instelarbeid", handlingCost: "Handlingarbeid", finishing: "Nabewerking", pricingFloor: "Minimumprijs" },
  pl: { ...enCopy, title: "Kalkulator kosztów cięcia laserowego i wycen | zaps.work", description: "Kalkuluj materiał, czas maszyny, przygotowanie, manipulację, odpady i marżę dla cięcia laserem.", heading: "Wycena cięcia laserowego", intro: "Przekształć dane z CAD/CAM w spójną i przejrzystą wycenę dla klienta.", material: "Materiał", mildSteel: "Stal czarna", stainlessSteel: "Stal nierdzewna", aluminum: "Aluminium", acrylic: "Pleksi / akryl", plywood: "Sklejka", other: "Inny materiał", materialThickness: "Grubość", thicknessUnit: "Jednostka grubości", materialArea: "Powierzchnia materiału", materialRate: "Cena materiału", wasteRate: "Naddatek / odpady", quantity: "Ilość", measurementUnit: "Układ jednostek", squareFeet: "sq ft", squareMeters: "m²", cutStats: "Dane cięcia i maszyny", cutLength: "Długość cięcia", cutLengthUnit: "Jednostka długości", cutTimeMinutes: "Czas cięcia", pierceCount: "Liczba przebić", machineRate: "Stawka za maszynę", setupHandling: "Przygotowanie i manipulacja", setupMinutes: "Czas przygotowania", handlingMinutes: "Czas manipulacji", laborRate: "Stawka robocizny", optionalCosts: "Obróbka i inne koszty", finishingCost: "Obróbka za sztukę", otherCost: "Inne koszty zlecenia", pricing: "Wycena", targetMargin: "Docelowa marża", packageDiscount: "Rabat pakietowy", taxRate: "Podatek", quoteDetails: "Dane wyceny", materialLine: "Usługa cięcia laserowego", targetQuote: "Docelowa wycena", directCost: "Koszty bezpośrednie", profit: "Zysk", margin: "Marża", materialCost: "Materiał", machineCost: "Maszyna", setupCost: "Robocizna przygotowania", handlingCost: "Robocizna manipulacji", finishing: "Obróbka końcowa", pricingFloor: "Cena minimalna" },
};
